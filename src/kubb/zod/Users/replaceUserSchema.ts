...
export const replaceUserPathParamsSchema = z.object({
 ...
 */
export const replaceUser200Schema = z.lazy(() => usersUserSchema)

/**
 * @description The server cannot find the requested resource.
 */
export const replaceUser404Schema = z.object({
  message: z.string(),
})

export const replaceUserMutationRequestSchema = z.object({
  data: z
    .object({
...
export const replaceUserMutationResponseSchema = z.lazy(() => replaceUser200Schema)