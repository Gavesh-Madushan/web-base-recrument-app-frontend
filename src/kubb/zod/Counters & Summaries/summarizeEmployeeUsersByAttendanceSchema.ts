...
export const summarizeEmployeeUsersByAttendanceQueryParamsSchema = z.object({
 ...
 */
export const summarizeEmployeeUsersByAttendance200Schema = z.object({
  ...
  lateUsers: z
    ...
    .optional(),
  expectedUsersCount: z.lazy(() => scalarsWSchema),
})

export const summarizeEmployeeUsersByAttendanceQueryResponseSchema = z.lazy(() => summarizeEmployeeUsersByAttendance200Schema)