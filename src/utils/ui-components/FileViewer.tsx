import { AppBar, Box, DialogContent, IconButton, Stack, Toolbar } from "@mui/material";
  ...
  return (
    ...
    >
      <AppBar sx={{ position: "relative" }}>
        <Toolbar>
          ...
          <Stack direction="row" justifyContent="flex-end" spacing={2} sx={{ width: "100%" }}>
            {(typeof file == "object" && file?.type !== "application/pdf") || (typeof file == "string" && file?.split(".")?.pop() !== "pdf") ? (
              <>
      ...
      <DialogContent style={{ display: "flex", justifyContent: "center" }}>
        {(typeof file == "object" && file?.type === "application/pdf") || (typeof file == "string" && file && file?.split(".")?.pop() === "pdf") ? (
