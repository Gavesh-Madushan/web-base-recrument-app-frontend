...
import { horizontalBarChart } from "./chart-data/summery-bar-charts-vertical";

function SeasonalRewardsChart({ campaignType }: { campaignType: number }) {
  ...
  return (
    <MainCard>
      <Grid container spacing={gridSpacing}>
        <Grid item xs={12}>
          {/* <Chart {...chartData} /> */}
          <Chart {...horizontalBarChart(theme.palette.mode, data)} />
        </Grid>
      </Grid>
    </MainCard>
  );
...
export default SeasonalRewardsChart;
