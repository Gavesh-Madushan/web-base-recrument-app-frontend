...
import { lineChart } from "./chart-data/summery-bar-charts-vertical";

function RewardsChart({ campaignType }: { campaignType: number }) {
  ...
  return (
    <MainCard>
      <Grid container spacing={gridSpacing}>
        <Grid item xs={12}>
          {/* <Chart {...chartData} /> */}
          <Chart {...lineChart(theme.palette.mode, data)} />
        </Grid>
      </Grid>
    </MainCard>
  );
