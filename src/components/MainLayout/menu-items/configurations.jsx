...
<svg xmlns="http://www.w3.org/2000/svg"
      strokeWidth=".4"
      stroke="currentColor"
       width="18" height="18" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16">
...
const configurations = {
  ...
  children: [
    ...
    // },
    // {
    //   id: "/config/default-message",
    //   title: "Default Messages",
    //   type: "item",
    //   url: "/config/default-message",
    //   icon: icons.default_message,
    //   role: [1],
    //   breadcrumbs: false,
    // },
  ],
